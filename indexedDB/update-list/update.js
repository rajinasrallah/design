...
function Addupdate() {
    ...
    let modal = document.createElement('div'); // Create a new div element
    modal.id = 'myModal'; // Set the id of the modal
    modal.className = 'modal'; // Set the class name of the modal
    ...
    let modalContent = `
        <div class="modal-content">
            ...
            <div class="inputContainer">
                <input type="number" id="numberInput" min="1" max="3"> <!-- Input field for entering a number between 1 and 3 -->
                <button id="popupAdd">Submit</button> <!-- Button to submit the entered number -->
            </div>
        </div>
    `; // Define the content of the modal

modal.innerHTML = modalContent; // Set the innerHTML of the modal to the defined content
document.body.appendChild(modal); // Append the modal to the body of the document
    ...
    document.getElementById('add').onclick = openModal;  // Set the onclick event for the first element with class 'add' to the openModal function
    ...
    document.getElementById('popupAdd').onclick = submitNumber;
...
html5rocks.indexedDB.open = function() {
    var request = indexedDB.open("myDatabase", 1); // Change version as needed
    ...
    request.onsuccess = function(event) {
        ...
        html5rocks.indexedDB.getAllTodoItems();
        Addupdate(); // Call Addupdate after update is done successfully
    };
};
